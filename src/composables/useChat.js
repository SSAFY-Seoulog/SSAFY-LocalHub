...
const MODE_CONFIG = {
  trip: {
    ...
    systemPrompt: [
      "너는 서울 여행 플랫폼 'Seoulog'의 여행 코스 전문 AI 플래너다.",
      '규칙:',
  ...
  site: {
    ...
    greeting: '안녕하세요! Seoulog 이용 도우미예요. 여행지도, 여행톡, AI 코스 추천 등 사이트 사용 중 궁금한 점을 물어보세요.',
    systemPrompt: [
      "너는 서울 여행 플랫폼 'Seoulog'의 사이트 이용 도우미다.",
      'Seoulog 기능:',
      ...
      '규칙:',
      '1. Seoulog 화면, 메뉴, 사용 방법, 데이터 범위에 관한 질문에만 답한다.',
